...
module.exports = {
  ...
  exportExcel: 'https://wx.sharkmeida.cn/api/order/export',
  downloadExcel: 'https://wx.sharkmeida.cn/api/order/downloadExcel',
  getUserInfoByCode: 'https://wx.sharkmeida.cn/api/wxpay/saveUserInfo',
  ...
  gatherOrderList: 'https://wx.sharkmeida.cn/gather/queryLike',  //订单列表
  lotteryOrderList: 'https://wx.sharkmeida.cn/lottery/queryLotteryLogById',  //订单列表
  distributionList: 'https://wx.sharkmeida.cn/' + 'distribution/queryAll',  //分销列表
  gatherList: 'https://wx.sharkmeida.cn/' + 'gather/queryAll',  //分销列表
  barginList: 'https://wx.sharkmeida.cn/' + 'bargin/queryAll',  //分销列表
  grouponList: 'https://wx.sharkmeida.cn/' + 'groupon/queryAll',
  lotteryList: 'https://wx.sharkmeida.cn/' + 'lottery/queryAll',
  querybusiness: 'https://wx.sharkmeida.cn/sys/log/listByPage',
  querydistribution: 'https://wx.sharkmeida.cn/distribution/listByPage',
